  ...
  return (
    <div className="flex gap-2.5 px-5 py-4 border-t border-border bg-bg-secondary shrink-0">
      <textarea
        ref={textareaRef}
        disabled={disabled}
        className="flex-1 bg-bg text-text border border-border rounded-[10px] px-3.5 py-2.5 font-sans text-[15px] leading-relaxed resize-none outline-none max-h-[200px] transition-colors focus:border-accent placeholder:text-text-muted disabled:opacity-50 disabled:cursor-not-allowed"
