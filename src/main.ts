...
async function main() {
  ...
  const instructions = [
    ...
    '- Scanner Grade A (≥70) + your analysis agrees + ENTRY ✓ → propose via proposeTradeWithButtons',
    '- Scanner Grade A but your analysis disagrees → explain why and either skip or propose with strong caveats',
    '- Scanner Grade B (55-69) + your independent analysis sees strong confluence → upgrade to proposal',
    '- Scanner Grade B without your confirmation → monitor only',
    '- Scanner Grade C (<55) but you spot a clear pattern in raw data → mention it but be cautious',
    '',
