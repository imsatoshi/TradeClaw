...
async function main() {
  ...
  const instructions = [
    ...
    '',
    '### Rules:',
    '- DO NOT use cryptoPlaceOrder for regular entries. Let NFI find entries via its signals.',
    ...
    '- DO use cryptoClosePosition (emergency) when systemic risk affects ALL pairs.',
